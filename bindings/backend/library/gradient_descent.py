...
class LRModel:
    @staticmethod
    def register():
        GlobalVar.name_to_prefunc["LinearRegressionModel#LinearR_load_pyhlist_py"] = LRModel.load_pyhlist_prefunc
        GlobalVar.name_to_func["LinearRegressionModel#LinearR_load_pyhlist_py"] = LRModel.load_pyhlist_func
        GlobalVar.name_to_func["LinearRegressionModel#LinearR_load_pyhlist_end_py"] = None
        GlobalVar.name_to_postfunc["LinearRegressionModel#LinearR_load_pyhlist_end_py"] = LRModel.load_pyhlist_end_postfunc
